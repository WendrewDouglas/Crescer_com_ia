...
import { NAV_LINKS, COURSES, CONTACT, WHATSAPP_URL } from "@/lib/constants";
    ...
    <footer className="bg-foreground pt-16 pb-8 text-white/70">
      <Container>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Preparando a próxima geração para um futuro com Inteligência Artificial
              de forma responsável, criativa e divertida.
            </p>
          </div>
          ...
          <nav aria-label="Cursos disponíveis">
            ...
            <ul className="space-y-2">
              {COURSES.map((course) => (
                <li key={course.title}>
                  <a href="#cursos" className="text-sm transition-colors hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-sm">
                ...
                <a href={CONTACT.instagram} target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-white">
                  @crescercomia
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm">
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-sm">
          &copy; {new Date().getFullYear()} Crescer com IA. Todos os direitos reservados.
        </div>
      </Container>
    </footer>
  );
